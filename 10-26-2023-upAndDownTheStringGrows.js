...
// P - Parameters
// We will be given a blank variable.  This is so weird.  

// R - Returns
// We will be expected to return that variable after converting it to upercase and then to lowercase, and it is expected that the length of the variable has changed.

// E - Examples
//    =>  None given go fuck yourself
//    =>

// P - Psuedocode
// 1.) ...?  I don't even know.  this isn't something that's solved logically.
// 2.) 
// 3.) 
// 4.) 
...
//This exercise was made to demonstrate how unicode characters can play tricks.  when that particular character goes through the process, it gets changed to "ss" which is longer.
//Neat lesson, but not a logic lesson.